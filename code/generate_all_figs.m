...
% Canonical MATLAB figure scripts present in this archive (obsolete/absent
% scripts such as plot_fig2_us.m and plot_mechanism.m are intentionally excluded;
% the canonical umbrella-coverage figure is code/fig7_coverage_gain.py).
scripts = { ...
    'plot_grid_2d.m', 'plot_asymmetric_1d.m', 'plot_rkhs_2d.m', ...
    'plot_rkhs_5panel.m', 'plot_coordfree_bias.m', 'plot_mechanism_v2.m', ...
    'plot_ras_pi_figs.m'};
